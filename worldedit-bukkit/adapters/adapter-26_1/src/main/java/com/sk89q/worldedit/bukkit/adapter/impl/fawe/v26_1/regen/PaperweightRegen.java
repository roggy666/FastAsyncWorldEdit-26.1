...
public class PaperweightRegen extends Regenerator {
    ...
    protected boolean initNewWorld() throws Exception {
        ...
        WorldOptions originalOpts = new WorldOptions(originalServerWorld.getSeed(), true, false);
        ...
        WorldGenSettings worldGenSettings = new WorldGenSettings(
                newOpts,
                new net.minecraft.world.level.levelgen.WorldDimensions(
                        originalServerWorld.registryAccess().lookupOrThrow(net.minecraft.core.registries.Registries.LEVEL_STEM)
                )
        );
        ...
        io.papermc.paper.world.PaperWorldLoader.LoadedWorldData loadedWorldData =
                new io.papermc.paper.world.PaperWorldLoader.LoadedWorldData(
                        "faweregentempworld",
                        null,
                        null,
                        null
